/*
  # Fix create_pending_trade_only to Include Auto-Accept Logic

  ## Summary
  The create_pending_trade_only function (used by admin panel) was missing
  auto-accept logic. This update adds the same auto-accept behavior that
  exists in create_pending_copy_trade.

  ## Changes
  - Loop through all followers and check auto-accept status
  - Call auto_accept_pending_trade for eligible followers
  - Track auto_accepted_count
*/
