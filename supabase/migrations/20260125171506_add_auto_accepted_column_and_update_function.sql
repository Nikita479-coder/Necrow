/*
  # Add auto_accepted column to pending_trade_responses

  ## Summary
  - Adds auto_accepted boolean column to track which trades were auto-accepted
  - Updates auto_accept_pending_trade function to set this flag
  - Enables Telegram notifications to show different message for auto-accepted trades
*/

ALTER TABLE pending_trade_responses 
ADD COLUMN IF NOT EXISTS auto_accepted boolean DEFAULT false;

-- Update the auto_accept function to set auto_accepted = true
