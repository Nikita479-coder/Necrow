/*
  # Fix execute_accepted_trade and Transaction Types
  
  ## Changes
  1. Add all existing transaction types to the constraint
  2. Fix transaction insert to use only existing columns
*/

-- Update constraint to include all existing types
...
-- Update execute_accepted_trade to use correct transaction columns
...
BEGIN
  ...
  -- Log transaction (only using columns that exist)
