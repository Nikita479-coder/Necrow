/*
  # Fix Close Trader Trade Total PNL Type
  
  ## Changes
  1. Fix type mismatch in close_trader_trade function
  2. Update total_pnl correctly as numeric type
*/
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      -- Update copy relationship with proper numeric handling
      ...
      SET 
        ...
        total_pnl = (COALESCE(total_pnl::numeric, 0) + v_follower_pnl)::text
      WHERE id = v_allocation.copy_relationship_id;
  ...
  -- Update trader stats (total_pnl is numeric)
