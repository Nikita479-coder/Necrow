/*
  # Fix Closing Fee - Use Notional Value (Include Leverage)

  ## Summary
  The closing fee was incorrectly calculated on margin only.
  It should be calculated on notional value (margin * leverage = position size * price)
  to be consistent with the opening fee calculation.

  ## Changes
  - Update close_position function to calculate fee on notional value
  - This ensures both opening and closing fees are calculated consistently

  ## Example
  - Position: 1.5278 BTC at $87,243.20
  - Leverage: 20x
  - Margin: $6,611.19
  - Notional: 1.5278 * $87,243.20 = $133,276.59
  - Old fee (on margin): $6,611.19 * 0.0004 = $2.64
  - New fee (on notional): $133,276.59 * 0.0004 = $53.31
*/
...
BEGIN
  ...
  -- This is consistent with opening fee calculation
