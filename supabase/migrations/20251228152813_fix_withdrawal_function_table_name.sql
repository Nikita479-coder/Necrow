/*
  # Fix Withdrawal Function Table Name

  Updates the create_withdrawal_request function to use the correct table name
  'locked_bonuses' instead of 'locked_trading_bonuses'.
  
  Changes:
  - Fixes query to use correct locked_bonuses table
*/
