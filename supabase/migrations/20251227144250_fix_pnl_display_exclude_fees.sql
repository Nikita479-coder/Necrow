/*
  # Fix PnL Display - Show Only Price Movement (Exclude Fees)

  1. Changes
    - realized_pnl now shows ONLY price movement (gross PnL)
    - Closing fee is still charged to wallet
    - Closing fee is tracked in cumulative_fees
    - Frontend displays pure price movement PnL
*/
...
BEGIN
  ...
  -- Transaction shows gross PnL and fee separately
