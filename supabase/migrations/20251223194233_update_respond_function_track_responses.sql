/*
  # Update respond_to_copy_trade to Track Responses

  1. Changes
    - Insert into pending_trade_responses when user responds
    - Update pending trade counters
    - Check pending_trade_responses to prevent duplicate responses

  2. Purpose
    - Ensure accepted/declined trades don't show in pending list
*/
...
BEGIN
  ...
  -- Update pending trade accepted counter
  UPDATE pending_copy_trades
