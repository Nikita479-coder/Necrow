/*
  # Fix Referral Tracking Column Names
  
  1. Changes
    - Fix get_referrer_statistics to use correct referral_stats column names
    - Use total_volume_all_time instead of total_trading_volume_generated
    - Fix get_referred_users_details to use correct column names
  
  2. Security
    - Maintain admin-only access
*/

-- Drop and recreate get_referrer_statistics with correct column names
...
-- Drop and recreate get_referred_users_details with correct column names
