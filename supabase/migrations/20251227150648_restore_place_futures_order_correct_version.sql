/*
  # Restore place_futures_order with Correct Commission Distribution

  Restores the correct version that uses distribute_commissions_unified
  with proper named parameters
*/
...
BEGIN
  ...
  -- Record opening fee (trigger will handle commission distribution)
