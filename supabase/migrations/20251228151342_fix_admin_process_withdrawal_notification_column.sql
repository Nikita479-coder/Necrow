/*
  # Fix Admin Process Withdrawal Notification Column

  Updates the admin_process_withdrawal function to use the correct column name
  'read' instead of 'is_read' for notifications table.
  
  Changes:
  - Fixes all notification inserts to use 'read' column
*/
