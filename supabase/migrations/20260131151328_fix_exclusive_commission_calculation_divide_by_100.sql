/*
  # Fix Exclusive Affiliate Commission Calculation

  ## Critical Bug
  Commission rates are stored as whole numbers (10 = 10%, 9 = 9%, etc.)
  but calculations were multiplying directly without dividing by 100.
  
  This caused commissions to be 100x too high:
  - $100 deposit × 10 = $1000 (WRONG)
  - $100 deposit × 0.10 = $10 (CORRECT)

  ## Solution
  Update all commission calculation functions to divide rate by 100
  before multiplying.

  ## Impact
  - distribute_exclusive_deposit_commission
  - distribute_exclusive_fee_commission  
  - distribute_exclusive_copy_profit_commission
*/

-- Fix deposit commission calculation
...
BEGIN
  ...
  LOOP
    -- Calculate commission for this tier level (divide rate by 100 to get decimal)
