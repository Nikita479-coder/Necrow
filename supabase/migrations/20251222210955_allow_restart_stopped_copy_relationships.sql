/*
  # Allow Restarting Stopped Copy Trading Relationships

  1. Changes
    - Update start_copy_trading function to allow restarting stopped relationships
    - If a stopped relationship exists, reactivate it instead of creating a new one
    - Only prevent duplicate if status = 'active'

  2. Notes
    - Fixes issue where users can't restart copy trading after stopping
    - Maintains prevention of true duplicates (active relationships)
*/
