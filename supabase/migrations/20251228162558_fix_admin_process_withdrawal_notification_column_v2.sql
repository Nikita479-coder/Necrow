/*
  # Fix Admin Process Withdrawal Function

  Updates the admin_process_withdrawal function to use the correct 'read' column
  instead of 'is_read' for notifications.
*/
...
BEGIN
  ...
  IF p_action = 'reject' THEN
    ...
    -- Create refund notification (using 'read' column)
