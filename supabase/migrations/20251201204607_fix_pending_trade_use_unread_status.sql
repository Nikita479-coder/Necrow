/*
  # Fix Pending Trade Function - Use Unread Status

  ## Overview
  Updates create_pending_copy_trade to use 'unread' status instead of 'pending'
  for copy_trade_notifications.

  ## Changes
  - Changes notification_status from 'pending' to 'unread'
  - Matches the check constraint requirements
