/*
  # Fix Impersonation Function - Use Correct Table Names
  
  The function was referencing non-existent tables. This fixes it to use:
  - admin_staff (not admin_staff_roles)
