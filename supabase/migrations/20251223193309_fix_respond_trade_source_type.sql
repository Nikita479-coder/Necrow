/*
  # Fix respond_to_copy_trade - Correct Source Type

  1. Changes
    - Change source_type from 'accepted' to 'pending_accepted'
    - Matches the check constraint on copy_trade_allocations

  2. Purpose
    - Fix constraint violation error when accepting pending trades
*/
