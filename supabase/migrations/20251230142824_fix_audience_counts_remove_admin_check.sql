/*
  # Fix Audience Counts - Remove Admin Check

  1. Fixes
    - Remove admin check from function since the page is already admin-protected
    - The RLS on the admin page handles authorization
*/
