/*
  # Fix Close Position - Calculate Fee on Margin Not Notional Value

  The closing fee should be calculated based on the margin allocated,
  not the notional value of the position. This is fair for traders
  using leverage.

  Example:
  - Position: 0.1 BTC at 20x leverage
  - Margin: $434.26
  - Notional: $8,755.20
  - Old fee: $8,755.20 * 0.0004 = $3.50
  - New fee: $434.26 * 0.0004 = $0.17
*/
