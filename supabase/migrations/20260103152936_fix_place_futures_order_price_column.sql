/*
  # Fix place_futures_order Price Column Reference

  ## Problem
  The function references non-existent column `mp.price` in market_prices table.
  The correct column name is `mp.last_price`.

  ## Solution
  Update the function to use `mp.last_price` instead of `mp.price`

  ## Impact
  Fixes "column mp.price does not exist" error
*/
...
BEGIN
  ...
  -- FIXED: Use mp.last_price instead of mp.price
