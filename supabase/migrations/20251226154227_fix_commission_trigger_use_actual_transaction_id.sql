/*
  # Fix Commission Trigger - Use Actual Transaction ID
  
  ## Problem
  The trigger was passing position_id as transaction_id, but referral_commissions
  has a foreign key constraint requiring a valid transactions.id
  
  ## Solution
  Look up the actual transaction ID from the transactions table that was created
  when the futures position was opened
  
  ## Changes
  - Updated trigger_distribute_commissions_on_fee to find real transaction ID
*/
