/*
  # Fix Withdrawal Request Function

  Recreates the withdrawal request function to work with transactions table only,
  without requiring a separate withdrawal_requests table.
  
  Changes:
  - Removes dependency on withdrawal_requests table
  - Uses transactions table for storing withdrawal requests
  - Adds locked withdrawal balance check
*/
