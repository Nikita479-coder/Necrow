/*
  # Fix award_user_bonus Function - Use Valid Notification Type

  ## Summary
  Updates the `award_user_bonus` function to use 'account_update' notification type
  instead of 'bonus' which is not in the allowed notification types list.

  ## Changes
  - Changes notification type from 'bonus' to 'account_update'
*/

-- Fix award_user_bonus to use 'account_update' notification type
