/*
  # Fix Execute Liquidation - Add Transaction Records and Locked Bonus Handling

  1. Changes
    - Update `execute_liquidation` to create transaction records
    - Deduct liquidated margin from locked_bonuses if position used locked bonus
    - Add proper notifications for liquidations

  2. Security
    - Function already has proper permissions
*/
