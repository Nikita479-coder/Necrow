/*
  # Fix Trader Metrics to Use Correct PNL Column
  
  1. Issue
    - calculate_trader_metrics function references `realized_pnl` column
    - Actual column in trader_trades table is `pnl`
    - This causes all ROI calculations to return 0
    
  2. Fix
    - Update calculate_trader_metrics to use `pnl` column instead
