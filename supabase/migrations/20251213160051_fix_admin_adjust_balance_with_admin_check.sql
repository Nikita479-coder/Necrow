/*
  # Fix Admin Adjust Balance - Add Admin Check and Permissions

  1. Changes
    - Add admin check to ensure only admins can adjust balances
    - Grant execute permission to authenticated users
    - Improve error handling and response format
*/
...
GRANT EXECUTE ON FUNCTION admin_adjust_user_balance(uuid, numeric, text, text) TO authenticated;
