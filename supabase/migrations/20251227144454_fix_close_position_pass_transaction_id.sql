/*
  # Fix Close Position - Pass Transaction ID to distribute_trading_fees

  1. Changes
    - Create transaction first and capture its ID
    - Pass transaction_id to distribute_trading_fees function
    - Fixes "function does not exist" error
*/
