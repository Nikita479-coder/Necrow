/*
  # Fix Multi-Tier Deposit Commissions to Skip All Exclusive Affiliates
  
  1. Changes
    - Update distribute_multi_tier_deposit_commissions to check entire upline
    - Skip regular commissions if ANY exclusive affiliate exists in upline (active or not)
    - Use has_exclusive_affiliate_in_upline function properly
    
  2. Reason
    - Currently only checks direct referrer
    - Doesn't skip when exclusive affiliate is inactive
