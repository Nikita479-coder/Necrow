/*
  # Fix Deposit Completion Idempotency

  ## Summary
  Updates the process_crypto_deposit_completion function to prevent double-crediting.
  If a deposit has already been completed (has completed_at timestamp), the function
  skips wallet crediting and transaction creation.

  ## Changes
  - Check if deposit already has completed_at before crediting
  - Return early with already_processed flag if already completed
  - Prevents both frontend polling and IPN callback from double-crediting
