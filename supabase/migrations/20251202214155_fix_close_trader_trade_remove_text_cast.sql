/*
  # Fix Close Trader Trade - Remove Text Cast
  
  ## Changes
  1. Remove ::text cast from total_pnl update
  2. Keep it as numeric since the column is numeric
*/
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      -- Update copy relationship - keep total_pnl as numeric
