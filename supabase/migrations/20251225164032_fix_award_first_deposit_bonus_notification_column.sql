/*
  # Fix Award First Deposit Bonus Notification Column

  ## Summary
  Fixes the notification insert to use the correct column name 'read' instead of 'is_read'.

  ## Changes
  - Changed is_read to read in notifications insert
*/
