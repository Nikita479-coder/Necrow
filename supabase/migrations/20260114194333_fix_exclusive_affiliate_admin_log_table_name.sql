/*
  # Fix Exclusive Affiliate Admin Log Table Name

  ## Description
  The admin_enroll_exclusive_affiliate function was attempting to insert into
  a non-existent table called "admin_action_logs". The correct table name is
  "admin_activity_logs". This migration fixes the function to use the correct
  table name.

  ## Changes
  - Updates admin_enroll_exclusive_affiliate to use admin_activity_logs instead of admin_action_logs
...
-- Fix the admin_enroll_exclusive_affiliate function to use the correct table name
