/*
  ...
  1. Changes
    - Fix get_referrer_statistics admin check to use boolean variable
    - Fix get_referred_users_details admin check to use boolean variable
    - Ensure functions properly validate admin status before returning data
  
  2. Security
    - Maintain admin-only access
    - Use proper variable types for admin check
*/
...
-- Drop and recreate get_referred_users_details with fixed admin check
