/*
  # Simplify Copy Trading Withdrawal Transaction Description

  ## Problem
  Copy trading withdrawal transactions show complex JSON details with profit, fees, etc.
  Users should just see a simple "Withdraw from [Trader Name]" message.
  
  ## Solution
  Update the transaction details to only include the trader name and withdrawal type.
*/
...
BEGIN
  ...
  IF v_withdraw_amount > 0 THEN
    ...
    IF v_withdraw_amount > 0 THEN
      ...
      -- Record transaction with simple description
