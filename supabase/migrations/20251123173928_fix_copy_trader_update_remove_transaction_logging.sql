/*
  # Fix Copy Trader Balance Update - Remove Transaction Logging

  1. Changes
    - Remove transaction logging since it's not critical
    - Focus on updating the copy relationship balances
*/
