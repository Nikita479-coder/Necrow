/*
  # Fix Respond to Trade - Auto-Create Wallet

  ## Overview
  Updates `respond_to_copy_trade` function to automatically create wallets
  if they don't exist, similar to how other trading functions work.

  ## Changes
  - Auto-creates USDT wallet if it doesn't exist
  - Uses INSERT ON CONFLICT for safe wallet creation
  - No longer throws "Wallet not found" error
