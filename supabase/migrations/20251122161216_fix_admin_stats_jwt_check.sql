/*
  # Fix Admin Stats Function JWT Check

  1. Changes
    - Update get_admin_stats to use correct JWT metadata path
    - Match the pattern used in RLS policies
*/

-- Update function to use correct JWT check
...
BEGIN
  -- Check if user is admin using same pattern as RLS policies
