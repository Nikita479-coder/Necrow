/*
  # Fix duplicate transfer_between_wallets functions

  1. Problem
    - Two versions of the function exist with different parameter orders
    - Causes ambiguous function call error

  2. Solution
    - Drop both versions and recreate with single signature
*/
...
-- Recreate with single definitive signature
