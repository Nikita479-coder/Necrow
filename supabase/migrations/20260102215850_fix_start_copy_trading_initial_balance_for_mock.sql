/*
  # Fix start_copy_trading Initial Balance for Mock Trading

  ## Problem
  The function was setting initial_balance to 0 for both mock and real copy trading.
  For mock trading, the initial balance should be calculated based on the $10,000 
  demo balance and the allocation percentage.

  ## Changes
  1. Calculate initial_balance for mock trading: 10000 * allocation_percentage / 100
  2. For real trading, calculate based on copy wallet balance
  3. Set current_balance equal to initial_balance when starting
