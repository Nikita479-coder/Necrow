/*
  # Fix Deposit Completion to Use Details Column

  ## Summary
  Fixes the process_crypto_deposit_completion function to use the correct
  'details' column instead of non-existent 'metadata' column.

  ## Changes
  - Replace metadata column with details column in transaction insert
  - Store payment information as formatted text instead of jsonb
