/*
  # Fix Admin Process Withdrawal Use Correct Column Name

  1. Problem
    - Function references non-existent column 'details'
    
  2. Solution
    - Use correct column name: 'metadata'
    - Also add required 'action_description' column
*/
