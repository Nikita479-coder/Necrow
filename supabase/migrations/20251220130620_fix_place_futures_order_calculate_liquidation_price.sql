/*
  # Fix place_futures_order to calculate liquidation price
  
  The function was not calculating the liquidation_price when creating positions,
  resulting in null values that cause frontend errors.
  
  Liquidation price formula:
  - Long: entry_price * (1 - 1/leverage + maintenance_margin_rate)
  - Short: entry_price * (1 + 1/leverage - maintenance_margin_rate)
  
  Using 0.5% maintenance margin rate (0.005)
*/
