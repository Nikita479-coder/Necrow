/*
  # Fix Create Pending Trade Function - Correct Notification Columns

  ## Overview
  Updates create_pending_copy_trade to use the correct columns for
  copy_trade_notifications table.

  ## Changes
  - Uses notification_status instead of is_read
  - Removes non-existent columns (trader_id, title, message)
  - Uses correct notification_type values
  
  ## Security
  - No security changes
  - Only fixes column references
*/
