/*
  # Fix Admin Process Withdrawal Function - Use Correct Table Name

  1. Updates
    - Fix admin_process_withdrawal function to use admin_activity_logs instead of admin_action_logs
  
  2. Notes
    - The table is called admin_activity_logs, not admin_action_logs
*/
...
BEGIN
  ...
  -- Log admin action (using correct table name: admin_activity_logs)
