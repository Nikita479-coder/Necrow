/*
  # Fix Admin Support Tickets Type Mismatch

  1. Changes
    - Cast varchar(255) columns to text to match function return type
    - Fix user_email and user_username type mismatches

  2. Notes
    - auth.users.email is varchar(255), needs to be cast to text
    - user_profiles.username may also need casting
*/
...
BEGIN
  ...
  SELECT 
    ...
    up.username::text as user_username,
    (
      SELECT COUNT(*)::bigint
