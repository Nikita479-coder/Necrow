/*
  # Fix Admin Process Withdrawal Function - Use Metadata Column

  1. Updates
    - Fix admin_process_withdrawal function to use metadata instead of details column
  
  2. Notes
    - The admin_activity_logs table has a 'metadata' column, not 'details'
*/
...
BEGIN
  ...
  -- Log admin action (using metadata column)
