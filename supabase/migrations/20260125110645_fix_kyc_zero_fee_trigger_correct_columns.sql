/*
  # Fix KYC Zero Fee Trigger - Correct Column Names
  
  1. Problem
    - The function was using wrong column names for admin_activity_logs
    - Correct columns are: admin_id, action_type, action_description, target_user_id, metadata
    ...
    IF v_is_fully_verified THEN
      ...
      IF NOT v_already_activated THEN
        ...
        INSERT INTO admin_activity_logs (
          ...
          NEW.user_id,
          'zero_fee_activated',
          'Zero trading fee promotion activated due to KYC verification',
          NEW.user_id,
          jsonb_build_object(
