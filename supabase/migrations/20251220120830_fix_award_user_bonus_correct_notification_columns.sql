/*
  # Fix award_user_bonus Function - Use Correct Notification Columns

  ## Summary
  Updates the `award_user_bonus` function to use the correct columns
  for the notifications table:
  - Use 'type' instead of 'category'
  - Use 'read' (boolean) instead of 'status'

  ## Changes
  - Updates notification INSERT to use correct column names
*/

-- Fix award_user_bonus to use correct notification columns
...
BEGIN
  ...
  -- Send notification (use correct column names: type and read)
