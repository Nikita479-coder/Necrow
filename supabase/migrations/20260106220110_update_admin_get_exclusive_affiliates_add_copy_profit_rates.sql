/*
  # Update admin_get_exclusive_affiliates to include copy_profit_rates

  1. Changes
    - Drop and recreate function to add copy_profit_rates to the returned fields
    - This allows the admin UI to display copy trading profit commission rates for each affiliate
*/
