/*
  # Fix Fee Rebate to Use Main Wallet Type

  1. Changes
    - Update apply_fee_rebate to use 'main' instead of 'spot' wallet type
    - Use correct wallet type constraint

  2. Purpose
    - Fix wallet type constraint violation
    - Credit rebates to user's main wallet
*/
