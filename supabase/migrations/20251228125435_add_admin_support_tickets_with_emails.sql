/*
  # Add Admin Function to Get Support Tickets with User Emails

  1. New Functions
    - `admin_get_support_tickets_with_users()` - Returns support tickets with user profile and email information
    - Only accessible by admin users
    - Includes username and email from auth.users

  2. Security
    - Function is SECURITY DEFINER to access auth.users
    - Includes admin check to prevent unauthorized access
*/

-- Function to get support tickets with user emails for admins
