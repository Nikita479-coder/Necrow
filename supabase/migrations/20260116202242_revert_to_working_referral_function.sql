/*
  # Revert to Working Referral Function

  ## Issue
  The updated function broke the referral lookup by adding an overly restrictive
  condition that prevented the recursive query from working properly.

  ## Changes
  Revert to the previous working version that was successfully returning referrals.
*/
