/*
  # Fix Pending Trade Notifications Trigger

  1. Changes
    - Update trigger function to use correct column name (allocation_percentage)
    - Fix to work with the actual copy_relationships schema

  2. Purpose
    - Ensure in-app notifications are created for followers
    - Allow followers to see and respond to pending trades
*/
