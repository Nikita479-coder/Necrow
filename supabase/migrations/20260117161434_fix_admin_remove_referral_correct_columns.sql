/*
  # Fix Admin Remove Referral - Correct Column Names
  
  Uses correct column names for admin_activity_logs
*/
...
BEGIN
  ...
  INSERT INTO admin_activity_logs (
    ...
    admin_user_id,
    'remove_referral',
    format('Removed referral relationship: %s was referred by %s. Reason: %s', v_target_email, v_old_referrer_email, reason),
    target_user_id,
    jsonb_build_object(
