/*
  # Fix transfer_between_wallets Column Name Error

  ## Problem
  - transfer_between_wallets function references "margin_balance" column
  - The actual column name in futures_margin_wallets is "locked_balance"
  - This causes errors when transferring to futures wallet

  ## Solution
  - Update the INSERT statement to use "locked_balance" instead of "margin_balance"

  ## Impact
  - Transfers between wallets (especially to futures) will work correctly
*/
...
BEGIN
  ...
  IF to_wallet_type_param = 'futures' THEN
    ...
    -- FIXED: Use locked_balance instead of margin_balance
