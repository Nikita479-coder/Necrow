/*
  # Fix Close Position Distribute Fees Call

  1. Changes
    - Update close_position to pass correct parameters to distribute_trading_fees
    - Get the fee_collection id to use as transaction reference
*/
