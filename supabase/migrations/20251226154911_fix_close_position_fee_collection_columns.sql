/*
  # Fix Close Position Fee Collection Columns

  1. Changes
    - Fix column names in fee_collections insert to match actual schema
    - Column is notional_size not trade_amount
    - No leverage column exists
*/
