/*
  # Fix Commission Trigger - Use Positional Parameters

  ## Problem
  Named parameters with := syntax causing type inference issues
...
BEGIN
  ...
  -- Calculate trade amount with explicit casting
  v_trade_amount := COALESCE(NEW.notional_size, NEW.fee_amount * 100);

  -- Call the unified commission distribution function with positional parameters
