/*
  # Fix Admin Adjust Card Balance - Use Correct Column

  1. Changes
    - Update admin_adjust_card_balance to use available_credit instead of balance_usdt
    - Shark cards have credit_limit, available_credit, and used_credit columns
    - Function now adjusts the available_credit field
