/*
  # Fix Transfer Between Wallets - Correct Format Specifiers

  ## Problem
  PostgreSQL's format() function doesn't support C-style format specifiers like %.2f.
  We need to use %s and round the numbers separately.

  ## Solution
  Replace format() calls with proper PostgreSQL string formatting.
*/
