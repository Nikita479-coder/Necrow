/*
  # Raise default limit on get_admin_users_list

  1. Changes
    - Increases the default p_limit from 500 to 10000 to support larger user bases
    - No other logic changes

  2. Notes
    - The frontend was calling without a limit parameter, hitting the 500 default
    - 10000 provides headroom for growth while still being a sensible cap
*/
