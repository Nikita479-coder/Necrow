/*
  # Create Referral Tracking Admin Functions
  
  1. New Functions
    - `get_referrer_statistics` - Returns comprehensive statistics for all referrers
    ...
    - `get_referred_users_details` - Returns detailed information about users referred by a specific referrer
  ...
  2. Security
    ...
    - Use is_user_admin() helper for authorization
*/

-- Function to get comprehensive referrer statistics
...
BEGIN
  ...
  GROUP BY up.id, up.full_name, up.email, up.country, up.created_at, up.kyc_status, rs.total_trading_volume_generated
