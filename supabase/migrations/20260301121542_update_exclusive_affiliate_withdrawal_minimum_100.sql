/*
  # Update exclusive affiliate withdrawal minimum to $100

  1. Changes
    - Updates the minimum withdrawal amount in `request_exclusive_affiliate_withdrawal`
      from $10 to $100 for exclusive affiliate wallet to main wallet transfers
    - Normal user withdrawals remain at $10 minimum
