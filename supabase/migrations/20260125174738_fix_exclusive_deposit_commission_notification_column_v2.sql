/*
  # Fix Exclusive Deposit Commission Notification Column

  1. Problem
    - distribute_exclusive_deposit_commission function uses 'is_read' column
    - The notifications table uses 'read' as the column name
    - This was causing the commission distribution to fail silently

  2. Solution
    - Drop and recreate the function with correct column name 'read'
*/
...
BEGIN
  ...
  LOOP
    ...
    IF v_commission_amount >= 0.01 THEN
      ...
      UPDATE exclusive_affiliate_stats
      SET deposit_commissions = deposit_commissions + v_commission_amount,
