/*
  # Fix Pending Trade Notifications Null Message

  1. Changes
    - Add fallback for trader name to prevent null messages
    - Ensure message is always populated with valid text

  2. Purpose
    - Fix "null value in column message" constraint violation
    - Ensure notifications always have readable messages
*/
