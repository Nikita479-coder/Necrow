/*
  # Fix Impersonation Function - Add Action Description
  
  The action_description column is NOT NULL, so we need to provide it.
*/
...
BEGIN
  ...
  INSERT INTO admin_activity_logs (
    ...
    'Created impersonation token for user ' || v_target_email,
    p_target_user_id,
    jsonb_build_object(
