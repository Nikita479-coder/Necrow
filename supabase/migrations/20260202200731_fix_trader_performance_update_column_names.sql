/*
  # Fix Trader Performance Update - Correct Column Names
  ...
  - win_rate_7d -> avg_win_rate_7d
  - win_rate_30d -> avg_win_rate_30d
*/
  ...
  LOOP
    ...
    FOR i IN 1..3 LOOP
      ...
      IF v_trade_side = 'long' THEN
        v_trade_exit := v_trade_entry * (1 + (v_trade_pnl / NULLIF(v_trade_size, 0)));
      ELSE
        v_trade_exit := v_trade_entry * (1 - (v_trade_pnl / NULLIF(v_trade_size, 0)));
      END IF;
