/*
  # Fix swap order type to use 'instant' instead of 'market'
  
  1. Changes
    - Updates execute_instant_swap to use 'instant' order type
    
  2. Notes
    - The swap_orders table only allows: 'instant', 'limit'
    - Market orders should be recorded as 'instant'
*/

-- Fix execute_instant_swap to use 'instant' instead of 'market'
...
BEGIN
  ...
  -- Record swap order with 'instant' type
  ...
  VALUES (
    ...
    'instant', v_exchange_rate, 'completed', v_fee_amount, now()
  )
