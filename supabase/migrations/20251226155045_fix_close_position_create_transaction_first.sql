/*
  # Fix Close Position - Create Transaction Before Fee Distribution

  1. Changes
    - Create the transaction record first
    - Use transaction ID for referral commission FK
*/
...
BEGIN
  ...
  -- Create transaction first (needed for referral commission FK)
  ...
  IF v_closing_fee > 0.0001 THEN
    ...
    -- Distribute referral commission using the transaction ID
