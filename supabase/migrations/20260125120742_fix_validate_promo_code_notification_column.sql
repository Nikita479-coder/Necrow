/*
  # Fix Promo Code Redemption Function

  1. Changes
    - Fix notification column name from 'notification_type' to 'type'
    - This was causing promo code redemption to fail silently

  2. Impact
    - Users registering with promo codes will now receive their bonus correctly
*/
...
BEGIN
  ...
  IF v_promo_record.bonus_type = 'copy_trading_only' THEN
    ...
    -- Create notification (using correct column name 'type')
