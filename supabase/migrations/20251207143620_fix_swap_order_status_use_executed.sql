/*
  # Fix swap order status to use 'executed' instead of 'completed'
  
  1. Changes
    - Updates execute_instant_swap to use 'executed' status
    
  2. Notes
    - The swap_orders table only allows: 'pending', 'executed', 'cancelled', 'expired'
    - Completed orders should be recorded as 'executed'
*/

-- Fix execute_instant_swap to use 'executed' instead of 'completed'
