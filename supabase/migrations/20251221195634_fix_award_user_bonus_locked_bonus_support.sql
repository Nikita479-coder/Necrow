/*
  # Fix award_user_bonus to Support Locked Bonuses

  1. Changes
    - Update award_user_bonus function to check is_locked_bonus flag
    - When is_locked_bonus is true, credit to locked_bonuses table instead of main wallet
    - Locked bonuses go into futures trading locked bonus, not main wallet
...
BEGIN
  -- Get bonus type info including is_locked_bonus flag
  SELECT name, is_locked_bonus, expiry_days 
  INTO v_bonus_type_name, v_is_locked_bonus, v_default_expiry 
  FROM bonus_types 
