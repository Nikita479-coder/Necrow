/*
  # Apply Zero Fee Promotion in Close Position

  1. Changes
    - Check if user has active zero fee promotion before calculating closing fee
    - If promotion is active, set closing fee to 0
    - Otherwise use normal fee rates
*/
...
BEGIN
  ...
  -- Recalculate closing fee if not already set by promo
