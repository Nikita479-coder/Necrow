/*
  # Fix award_user_bonus Function - Use Correct Transaction Columns

  ## Summary
  Updates the `award_user_bonus` function to use the correct columns
  for the transactions table (no wallet_id column exists).

  ## Changes
  - Removes wallet_id from transaction INSERT
  - Uses details column for transaction metadata
*/

-- Fix award_user_bonus to use correct transaction columns
