/*
  # Fix 7-Day Win Rate Calculation for Traders

  1. Problem
    - The calculate_trader_metrics function doesn't update avg_win_rate_7d
    - It's stuck at a default value (50%) regardless of actual trade performance
    - Satoshi Academy has 18 wins / 2 losses in 7 days = 90% win rate, but shows 50%

  2. Solution
    - Update the function to calculate period-specific win rates
    - Calculate avg_win_rate_7d from actual trades in the last 7 days
    - Also update avg_win_rate_90d for consistency

  3. Changes
    - Add 7-day and 90-day win rate calculations to calculate_trader_metrics
    - For non-automated traders: Calculate from actual trades in those periods
    - For traders with base values: Blend base values with actual trades
*/
...
BEGIN
  ...
  -- Update trader with combined metrics including period-specific win rates
  UPDATE traders
  SET
