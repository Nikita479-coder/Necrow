/*
  # Create Close Trader Trade Function
  
  ## Changes
  1. Create a function to close trades directly from trader_trades
  2. This mirrors close_admin_trade but works with trader_trades table
  3. Handles PNL distribution to all followers
*/
