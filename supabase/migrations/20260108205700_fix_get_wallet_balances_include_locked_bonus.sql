/*
  # Fix get_wallet_balances to include locked bonus

  1. Changes
    - Add locked bonus balance to the response
    - Include locked bonus in total_trading_available
    - Return futures structure that matches frontend expectations

  2. Purpose
    - Allow users to see and use their locked bonus for futures trading
*/
