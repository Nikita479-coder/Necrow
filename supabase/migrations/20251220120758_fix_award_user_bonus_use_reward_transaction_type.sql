/*
  # Fix award_user_bonus Function - Use Valid Transaction Type

  ## Summary
  Updates the `award_user_bonus` function to use 'reward' transaction type
  instead of 'bonus' which is not in the allowed transaction types list.

  ## Changes
  - Changes transaction_type from 'bonus' to 'reward'
*/

-- Fix award_user_bonus to use 'reward' transaction type
