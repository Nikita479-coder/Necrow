/*
  # Fix admin_reject_kyc_full_reset - admin_staff column name

  1. Changes
    - Fix admin_staff check to use `id` instead of `user_id` (column doesn't exist)

  2. Notes
    - admin_staff table uses `id` as the user identifier, not `user_id`
*/
