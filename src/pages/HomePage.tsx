...
function HomePage() {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      subtitle: 'Get 20 USDT',
      description: 'Verify your identity and unlock full trading capabilities. Receive 20 USDT instantly upon successful KYC verification!',
      cta: 'Verify Now',
      ctaAction: () => navigateTo('kyc'),
      visual: 'bonus',
      reward: '20 USDT',
      status: 'available',
    },
