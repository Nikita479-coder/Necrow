    ...
    <div className="min-h-screen bg-[#181a20] text-white">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-6">
        ...
        <div className="bg-gradient-to-r from-[#1a1d24] to-[#0b0e11] rounded-xl p-4 mb-6 border border-gray-800">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="text-sm text-gray-400">
              {activeProgram === 'referral' ? (
                <span>Single-tier direct commissions up to {vipLevels[currentVIP - 1]?.commission || 10}%</span>
              ) : (
                <span>5-tier network with multiple compensation plans</span>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-[#2b3139] rounded-xl p-6 border border-[#3d4450]">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-[#eaecef]">Direct commission on referral trading fees (10-70% based on VIP)</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">Referrals get 5-15% fee rebate for 30 days</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">Simple and straightforward earning model</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">Best for casual referrers</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-[#2b3139] rounded-xl p-6 border border-[#3d4450]">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">5-tier network with override commissions</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">4 compensation plans: RevShare, CPA, Hybrid, Auto-Optimize</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">CPA bonuses: $10 KYC, $25 deposit, $50 trade, $100 volume</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0ecb81] mt-0.5 flex-shrink-0" />
                <span className="text-[#eaecef]">Best for professional affiliates building networks</span>
              </li>
            </ul>
          </div>
        </div>
